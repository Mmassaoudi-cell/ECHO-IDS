...
- Gated temporal/graph fusion.
- Binary and multiclass intrusion heads.
- Temperature scaling and validation-stacked prediction.
- Structured evidence construction.
- EG-SINdex semantic clustering and evidence verification.
- Unsupported-claim explanations and joint pipeline inference.

The remaining folders provide preprocessing, training loops, baselines, tuning,
and experiment reproduction around this canonical architecture.
